...
const CloseButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className="focus:outline-none absolute -top-3 -right-3 bg-gray-50 rounded-full p-2 cursor-pointer shadow transform duration-700 ease-in-out hover:rotate-90"
    >
      <svg
        color="#CE3653"
        width="20"
